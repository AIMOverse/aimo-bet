...
// ============================================================================
// Polymarket Gamma API - Get Market by ID
// Docs: https://docs.polymarket.com/api-reference/markets/get-market-by-id
// ============================================================================

// ============================================================================
// GET /api/polymarket/gamma/markets/[id] - Get market by ID
// ============================================================================
...
export async function GET(
  ...
  try {
    ...
    const path = `/markets/${id}${queryString ? `?${queryString}` : ""}`;

    console.log("[polymarket/gamma/markets] Fetching market by id:", id);
