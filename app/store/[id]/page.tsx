...
export default function StoreDetailPage({ params }: PageProps) {
  ...
  const itemName = useMemo(() => {
    ...
    switch (type) {
      case "model":
        return (item as (typeof models)[0]).name;
      case "agent":
        return (item as (typeof agents)[0]).name;
      case "tool":
        return (item as (typeof tools)[0]).agent_name;
      default:
        return "Item";
    }
  }, [item, type, models, agents, tools]);
    ...
    return (
      <div className="flex h-full flex-col">
        <header className="flex h-14 shrink-0 items-center gap-2 border-b px-4">
          <SidebarTrigger className="-ml-1" />
          <Separator orientation="vertical" className="h-4" />
          <h1 className="text-sm font-medium truncate">{model.name}</h1>
        </header>
        <div className="flex-1 overflow-auto">
          <div className="container max-w-4xl py-6">
            <Link href="/store">
    ...
    return (
      <div className="flex h-full flex-col">
        <header className="flex h-14 shrink-0 items-center gap-2 border-b px-4">
          <SidebarTrigger className="-ml-1" />
          <Separator orientation="vertical" className="h-4" />
          <h1 className="text-sm font-medium truncate">{tool.agent_name}</h1>
        </header>
        <div className="flex-1 overflow-auto">
          <div className="container max-w-4xl py-6">
